...
* Deterministic weighted financial resilience model.
* 
* Liquidity and banking conditions carry
...
function evaluateFinancialPrinciples(
state
) {
...
case "FIN_STRESS":
  return "GENERAL_FINANCIAL_STRESS";
